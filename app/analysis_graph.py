...
- 离职员工出售客户名单给竞争对手的案件，通常不涉及婚姻家庭、产品侵权、监察法；除非用户事实明确提到相关内容，否则不得引用这些法律。
- 法律依据必须服务于具体争议焦点，不能仅因检索结果中出现就引用。
- “案件类型”不得机械复用 decompose 阶段的单一领域，应结合案情事实重新归纳。
- 如果案情同时涉及合同/劳动合同违约和侵权/不正当竞争，应写成“复合型纠纷”。
- 对“离职员工把客户名单卖给竞争对手”类案件，案件类型建议写为：
  “复合型纠纷，涉及劳动合同/保密协议违约与侵犯商业秘密、不正当竞争责任”
  或：
  “离职员工泄密纠纷，可能涉及保密义务违反、侵犯商业秘密及不正当竞争”
- 不得仅输出“劳动争议 - 劳动合同纠纷”，除非用户事实只涉及劳动关系内部争议，不涉及客户名单、商业秘密、竞争对手使用等内容。
- “涉及法律关系”应区分内部劳动/合同关系与外部侵权/竞争关系。
- 对客户名单泄露案件，主要领域应包括：
  - 商业秘密保护
  - 不正当竞争
  - 劳动合同/保密协议违约
- 可能涉及应包括：
  ...
  - 情节严重时的刑事责任线索
- 处理路径必须区分不同请求基础：
  1. 如果基于劳动合同、保密协议、竞业限制协议追究员工违约责任，通常考虑劳动仲裁或相关合同约定路径；
  2. 如果主张客户名单构成商业秘密并追究员工、竞争对手责任，应考虑向法院提起侵犯商业秘密/不正当竞争民事诉讼；
  3. 可根据证据情况申请证据保全、行为保全；
  4. 可向市场监管部门举报不正当竞争行为；
  5. 涉案金额、损失或情节严重时，可评估刑事报案。
- 不得简单写成“向劳动争议仲裁委员会申请仲裁”作为唯一处理路径。
- 离职员工出售客户名单给竞争对手的案件通常不涉及食品安全法；除非用户事实明确提到食品生产、餐饮、食品销售、食品安全事故或食品监管处罚，否则不得引用《食品安全法》。
"""
